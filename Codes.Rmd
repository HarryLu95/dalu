...
###1.3 Corresponding HTML & CSS of Default Output
```{}
title:
  HTML: <h1 class="title">
  CSS: h1.title
author:
  HTML: <h4 class="author">
  CSS: h4.author
date:
  HTML: <h4 class="date">
  CSS: h4.date
...
##(2) Markdown Syntax / RMarkdown Syntax
###2.1 Headers
```{}
#Header Level 1
##Header Level 2
...
###2.4 Horizontal Rules / Horizontal Lines
```{}
---
```
